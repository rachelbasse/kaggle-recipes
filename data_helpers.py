...
supertypes = {
    ...
    'candy': ['brittle', 'dragee', 'gumdrop', 'praline', 'toffee'],
    'cereal': ['amaranth', 'barley', 'buckwheat', 'bran', 'bulgur', 'groat',
               'malt', 'millet', 'oat', 'oatmeal', 'sorghum', 'spelt', 'triticale', 'wheat', 'wheatberrie'],
    ...
    'cherry': ['maraschino'],
    'coffee': ['cappuccino'],
    'cookie': ['amaretti', 'biscotti', 'cone', 'gingersnap', 'macaron', 'shortbread', 'snap'],
    ...
    'fish': ['abalone', 'ahi', 'albacore', 'amberjack', 'anchovy', 'barramundi', 'bas', 'basa', 'branzino', 'bream', 'brill',
             ...
             'octopu', 'perch', 'pike', 'pollock', 'pompano', 'redfish', 'rockfish', 'roughy', 'sablefish', 'salmon',
             'sashimi', 'scrod', 'shad', 'shark', 'snapper', 'sockeye', 'sole', 'sturgeon', 'swordfish',
             'tentacle', 'tilapia', 'trout',
    ...
    'flour': ['besan'],
    'flower': ['dandelion', 'hibiscu', 'hop', 'orchid', 'pansy'],
    'fruit': ['boysenberry', 'breadfruit', 'citru', 'honeydew', 'kiwi', 'umeboshi', 'wolfberry'],
    'honey': ['abbamele'],
    'icecream': ['pop', 'popsicle', 'sherbet', 'sorbet'],
    'lettuce': ['iceberg'],
    'liqueur': ['bénédictine', 'cordial', 'kirschenliqueur', 'kirschwasser'], 
    'liquor': ['absinthe', 'alcohol', 'moonshine'],   
    'meat': ['asada', 'bacon', 'bear', 'beef', 'belly', 'bison', 'blade', 'blood', 'boar', 'bone', 'bonein',
             ...
             'loin', 'marrow', 'mignon', 'moose', 'mutton', 'neck', 'nugget', 'oxtail', 
    ...
    'seasoning': ['ajwain', 'allspice', 'amchur', 'anise', 'annatto', 'asafoetida', 'bark', 'basil', 'berry',
                  ...
                  'lemongras', 'licorice', 'menthe', 'mint', 'mitsuba',
